...
export class MediaShape extends ShapeExtension implements Shape {
    ...
    protected initNodes(title?: MultilingualString, selectable?: boolean, left?: number, top?: number) {
        ...
        if (this.nodes) {
            ...
            if (imageNode) {
                this.fabricShapes.push(new FabricImageShape((this.definition as DrawingImageShapeDefinition), Object.assign({}, imageNode.properties , { left: position.left, top: position.top, selectable: selectable }, strokeProperties)));
            }
            if (textNode) {
            ...
            this.fabricShapes.push(new FabricImageShape((this.definition as DrawingImageShapeDefinition),Object.assign({ left: position.left, top: position.top, selectable: selectable }, strokeProperties)));
