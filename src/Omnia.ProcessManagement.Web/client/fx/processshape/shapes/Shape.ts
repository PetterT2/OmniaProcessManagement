...
export declare abstract class Shape implements ShapeObject {
    ...
    static getTextPosition(definition: DrawingShapeDefinition, centerPoint: fabric.Point, left?: number, top?: number, width?: number, height?: number): { left: number, top: number };
}
