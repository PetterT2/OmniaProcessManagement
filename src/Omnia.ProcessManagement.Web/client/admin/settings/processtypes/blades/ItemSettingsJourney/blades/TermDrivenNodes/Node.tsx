...
//import { DocumentTypeItemSettings, TermDrivenPublishingApprovalSettings } from '../../../../../../../fx/models';
...
export class TermDrivenNodeComponent extends tsx.Component<TermDrivenComponentProps>
{
    ...
    //    this.termDrivenMap = ((this.processTypeJourneyStore.getters.editingDocumentType()
    //        .settings as DocumentTypeItemSettings)
    ...
    //            {
    //                !this.rootNode &&
    //                <v-checkbox label={this.loc.InheritParentSettings}
    ...
    //    return !this.isInherit && <div class={this.styles.noWrap}>{this.userNames || this.loc.NoApproverFound}</div>
    //}
