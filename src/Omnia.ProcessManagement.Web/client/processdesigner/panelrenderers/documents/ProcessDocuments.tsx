...
export class ProcessDocumentsTabRenderer extends TabRenderer {
    generateElement(h): JSX.Element {
        return (<ProcessDocumentsComponent key={Guid.newGuid().toString()}></ProcessDocumentsComponent>);
    }
}
...
@Component
export class ProcessDocumentsComponent extends VueComponentBase<ProcessDrawingProps, {}, {}>
{
