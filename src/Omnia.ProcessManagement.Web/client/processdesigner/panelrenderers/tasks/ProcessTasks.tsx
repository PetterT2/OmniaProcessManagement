...
export class ProcessTasksTabRenderer extends TabRenderer {
    generateElement(h): JSX.Element {
        return (<ProcessTasksComponent key={Guid.newGuid().toString()}></ProcessTasksComponent>);
    }
}
...
@Component
export class ProcessTasksComponent extends VueComponentBase<ProcessDrawingProps, {}, {}>
{
