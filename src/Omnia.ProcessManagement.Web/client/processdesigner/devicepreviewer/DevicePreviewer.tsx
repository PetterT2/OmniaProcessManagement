...
export default class DevicePreviewerComponent extends tsx.Component<DevicePreviewerProps>
{
    ...
    private createIframeUrl() {
        ...
        return OPMUtils.createProcessNavigationUrl(currentProcess.process, currentProcess.current.processStep, previewPageUrl, false);
    }
        ...
        return <v-content column>
            <v-layout align-center column class={DevicePreviewerStyles.fullScreen}>
                ...
                <div class={DevicePreviewerStyles.deviceWrapper(this.model.currentDisplayBreakPoint, this.model.iFrame.height)}>
                    <iframe id={this.iFrameId} src={this.createIframeUrl()} scrolling="no" height={this.model.iFrame.height} sandbox="allow-same-origin allow-scripts allow-popups allow-top-navigation" class={DevicePreviewerStyles.iFrame}></iframe>
                </div>
            </v-layout>
        </v-content>
    }
