...
export interface ShapeSelectionProps {
    ...
    enableShowMoreSettings?: boolean;
...
export class ShapeTypeComponent extends VueComponentBase<ShapeSelectionProps> implements IWebComponentInstance {
    ...
    @Prop() enableShowMoreSettings?: boolean;
    ...
    private showMoreSettings: boolean = false;
    ...
    created() {
        this.init();
        this.showMoreSettings = !this.enableShowMoreSettings;
    }
