...
namespace Omnia.ProcessManagement.Core.Services.Processes
{
    public interface IProcessService
    {
        ...
        ValueTask<Process> PublishProcessAsync(Guid opmProcessId, string comment, bool isRevision, Guid? securityResourceId = null);
        ...
        ValueTask<List<ProcessWithAuditing>> GetProcessesAsync(Guid teamAppId, ProcessVersionType versionType);
